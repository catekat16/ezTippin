...
struct Colors {
    ...
    static let purple = UIColor(red: 127.5/255.0, green: 0.0/255.0, blue: 127.5/255.0, alpha: 1.0)
    static let pink = UIColor(red: 233.0/255.0, green: 0.0/255.0, blue: 255.0/255.0, alpha: 1.0)
